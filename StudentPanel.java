...
public class StudentPanel {
    ...
    public static void launch(String studentID) {
        JFrame panelFrame = new JFrame("Student Panel");
        ...
        File file = new File("C:/Users/fatim/Downloads/std2.png");
        if (!file.exists()) {
...
// ✅ Load and place icon on top
        ImageIcon iconImg = new ImageIcon("C:/Users/fatim/Downloads/std2.png"); // or different image
...
// ✅ Add icon to background
        ...
        for (String item : menuItems) {
            ...
            btn.addActionListener(e -> {
                ...
                switch (item) {
                    case "📚 View Grades":
                        new GradesForm(studentID);
                        break;
                    case "🧾 Download report card":
                        new DownloadReport(studentID);
                        break;
                    case "🚪 Logout":
